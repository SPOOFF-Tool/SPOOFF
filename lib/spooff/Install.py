...
HELP = """
Syntax from src dir: make lib-spooff args="-b"
                 or: make lib-spooff args="-p /usr/include/eigen3"
...
make lib-spooff args="-b"   # download/build in default lib/spooff/eigen-eigen-*
make lib-spooff args="-p /usr/include/eigen3" # use existing Eigen installation in /usr/include/eigen3
"""
...
# create link in lib/spooff to Eigen src dir
