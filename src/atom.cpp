...
Atom::Atom(LAMMPS *_lmp) : Pointers(_lmp)
{
  ...
  starting_neighs = nullptr;
  youngs = nullptr;
  poissons = nullptr;
  linear_expansion = nullptr;
  tsph = nullptr;
  rhosph = nullptr;
  pesph = nullptr;
  dpesph = nullptr;
...
void Atom::peratom_create()
{
  ...
  add_peratom("starting_neighs",&starting_neighs,DOUBLE,0);
  add_peratom("youngs",&youngs,DOUBLE,0);
  add_peratom("poissons",&poissons,DOUBLE,0);
  add_peratom("linear_expansion",&linear_expansion,DOUBLE,0);
  add_peratom("tsph",&tsph,DOUBLE,0);
  add_peratom("rhosph",&rhosph,DOUBLE,0);
  add_peratom("pesph",&pesph,DOUBLE,0);
  add_peratom("dpesph",&dpesph,DOUBLE,0,1);             // set per-thread flag
  add_peratom("qsph",&qsph,DOUBLE,3);
  add_peratom("cpsph",&cpsph,DOUBLE,0);
  add_peratom("ksph",&ksph,DOUBLE,0);
...
void *Atom::extract(const char *name)
{
  ...
  if (strcmp(name, "starting_neighs") == 0) return (void *) starting_neighs;
  if (strcmp(name, "youngs") == 0) return (void *) youngs;
  if (strcmp(name, "poissons") == 0) return (void *) poissons;
  if (strcmp(name, "linear_expansion") == 0) return (void *) linear_expansion;
  if (strcmp(name, "tsph") == 0) return (void *) tsph;
  if (strcmp(name, "rhosph") == 0) return (void *) rhosph;
  if (strcmp(name, "pesph") == 0) return (void *) pesph;
  if (strcmp(name,"dpesph") == 0) return (void *) dpesph;
  if (strcmp(name, "qsph") == 0) return (void *) qsph;
  if (strcmp(name, "cpsph") == 0) return (void *) cpsph;
  if (strcmp(name, "ksph") == 0) return (void *) ksph;
...
int Atom::extract_datatype(const char *name)
{
  ...
  if (strcmp(name, "starting_neighs") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name, "youngs") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name, "poissons") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name, "linear_expansion") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name, "tsph") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name, "rhosph") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name, "pesph") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name,"dpesph") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name, "qsph") == 0) return LAMMPS_DOUBLE_2D;
  if (strcmp(name, "cpsph") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name, "ksph") == 0) return LAMMPS_DOUBLE;
