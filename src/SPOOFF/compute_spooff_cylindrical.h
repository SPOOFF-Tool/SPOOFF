...
#ifdef COMPUTE_CLASS
// clang-format off
ComputeStyle(spooff/cylindrical,ComputeSPOOFFCylindrical);
// clang-format on
#else

#ifndef LMP_COMPUTE_SPOOFF_CYLINDRICAL_H
#define LMP_COMPUTE_SPOOFF_CYLINDRICAL_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeSPOOFFCylindrical : public Compute {
 public:
  ComputeSPOOFFCylindrical(class LAMMPS *, int, char **);
  ~ComputeSPOOFFCylindrical() override;
  void init() override;
