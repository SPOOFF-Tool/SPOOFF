...
#ifdef COMPUTE_CLASS
// clang-format off
ComputeStyle(spooff/conductivity,ComputeSPOOFFConductivity);
// clang-format on
#else

#ifndef LMP_COMPUTE_SPOOFF_CONDUCTIVITY_H
#define LMP_COMPUTE_SPOOFF_CONDUCTIVITY_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeSPOOFFConductivity : public Compute {
 public:
  ComputeSPOOFFConductivity(class LAMMPS *, int, char **);
  ~ComputeSPOOFFConductivity() override;
  void init() override;
