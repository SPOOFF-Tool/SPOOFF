...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(spooff/tlsph,PairTlsph);
// clang-format on
#else
...
class PairTlsph : public Pair {
 public:
  ...
  void effective_longitudinal_modulus(const int itype, const double shear, const double bulk,
                                      const double m_modulus, const double dt, const double d_iso,
  ...
  void ComputePressure(const int i, const double rho, const double mass_specific_energy, const double temperature,
 ...
 protected:
  ...
  bool *contact_thermal, *contact_mechanical;
  ...
  enum {
    ...
    EOS_THERMAL = 51,
    EOS_THERMAL_T0 = 52,
    EOS_THERMAL_ALPHA = 53,
    THERMAL_CONDUCTIVITY = 54,
    HEAT_PRODUCED = 55,
    CONTACT_DISTANCE_SCALING = 56,
    CONTACT_FORCE_SCALING = 57,
    CONTACT_DAMPING_SCALING = 58,
    CONTACT_RESTITUTION = 59,
    MAX_KEY_VALUE = 60
